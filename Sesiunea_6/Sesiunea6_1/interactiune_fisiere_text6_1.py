""""
Practica sesiunea 6_1 -  Interactiunea cu fisiere text
"""
...
# dupa ce interactionam cu un fisier, acesta trebuie inchis pentru ca vor ramane datele din fisier vulnerabile.
# scade eficienta programului/aplicatiei noastre pentru ca orice fisier deschis este o resursa care ocupa memorie
fisier.close()
fisier1.close()

# => with statement este o abordare mai buna/ abordarea preferata
# de interactiune cu fisierele pentru ca partea de curatare/clean up/ inchidere fisier are loc automat pentru noi
...
# scriem informatii intr-un fisier nou (il si cream in acelasi timp) folosind modul "w"

with open("dummy2.txt", mode="w") as file:
    file.write("Continut nou")

# suprascriem continutul dintr-un fisier existent folosind tot modul "w"
...
# extindem/actualizam continutul unui fisier tex folosind modul "a"
